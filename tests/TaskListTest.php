...
class TaskListTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @dataProvider collectionOfTasksProvider
     */
    public function testCollectionOfTasks($cTasks, $uTasks)
    {
        //I WAS UNABLE TO IDENTIFY THE FLAG FOR COMPLETED,
        //UNCOMPLETED FROM .CSV SO I SET UP THE TASK FOR ARBITRARY
        //TESTING
        $completedTasks= $cTasks;
        $uncompletedTasks = $uTasks;
        $this->assertEquals(TRUE, $uncompletedTasks > $completedTasks);
    }

    public function collectionOfTasksProvider(){
        return [
            [20, 1],
            [10, 30],
            [5, 6],
